...
async def add_prompt(name: str, owner_type: OwnerType, user_id: uuid.UUID = None):
    """
    ...
    """
    return await add_or_update_prompt(name=name, owner_type=owner_type, user_id=user_id)
