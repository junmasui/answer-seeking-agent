...
class Answer(CamelModel):
    """
    Represents an answer to a user's question, including the question, answer, citations, and
...
class AnswerRequestBody(CamelModel):
    """
    Represents the request body for seeking an answer, containing the user's input and optional
