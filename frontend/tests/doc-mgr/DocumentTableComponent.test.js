...
describe('DocumentTableComponent.vue', () => {
  ...
  it('calls ingest API when ingest single item is confirmed', async () => {
    ...
    const ingestIcon = wrapper
      .findAll('.v-icon-stub')
      .find((icon) => icon.text() === 'mdi-database-import')
  ...
  it('calls ingest all uploaded API when button clicked', async () => {
    const ingestAllButton = wrapper
      .findAll('button')
      .find((b) => b.text() === 'Ingest All Uploaded')
  ...
  it('calls ingest selected API when button clicked', async () => {
    ...
    const ingestSelectedButton = wrapper
      .findAll('button')
      .find((b) => b.text() === 'Ingest Selected')
