...
if [ -z "$APPLICATION_JWT_SECRET" ]; then
    ...
    echo -e "\n# APPLICATION_JWT_SECRET is created thru openssl rand -hex 32.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$MINIO_ROOT_PASSWORD" ]; then
    ...
    echo -e "\n# Minio's root account's password.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$BACKEND_MINIO_USER_PASSWORD" ]; then
    ...
    echo -e "\n# backend's Minio\n# account's password.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_MINIO_USER_PASSWORD" ]; then
    ...
    echo -e "\n# Langfuse's Minio account's password.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$REDIS_DEFAULT_PASSWORD" ]; then
    ...
    echo -e "\n# REDIS_DEFAULT_PASSWORD contains Redis's default account's password  (auto-generated secret)" >> quick_fill.secrets.env
    echo "REDIS_DEFAULT_PASSWORD=${REDIS_DEFAULT_PASSWORD}" >> quick_fill.secrets.env
fi


if [ -z "$POSTGRES_PASSWORD" ]; then
    export POSTGRES_PASSWORD="postgres_$(gpg --gen-random --armour 1 16 | tr '+/' '-_' | tr -d '=')"
    echo -e "\n# POSTGRES_PASSWORD contains Postgres's root account's password  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$BACKEND_POSTGRES_USER_PASSWORD" ]; then
    ...
    echo -e "\n# backend's Postgres account's password.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_POSTGRES_USER_PASSWORD" ]; then
    ...
    echo -e "\n# Langfuse's Postgres account's password.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$GRAFANA_ADMIN_PASSWORD" ]; then
    ...
    echo -e "\n# Grafrana's admin account's password  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$CLICKHOUSE_DEFAULT_USER_PASSWORD" ]; then
    ...
    echo -e "\n# Clickhouse's default account's password  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$CLICKHOUSE_ADMIN_USER_PASSWORD" ]; then
    ...
    echo -e "\n# Clickhouse's admin account's password  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_CLICKHOUSE_USER_PASSWORD" ]; then
    ...
    echo -e "\n# backend's Clickhouse account's password.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_SALT" ]; then
    ...
    echo -e "\n# LANGFUSE_SALT contains langfuse's salt.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_ENCRYPTION_KEY" ]; then
    ...
    echo -e "\n# LANGFUSE_ENCRYPTION_KEY contains langfuse's encryption key.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_INIT_USER_PASSWORD" ]; then
    ...
    echo -e "\n# langfuse's initial users's password.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_INIT_PROJECT_SECRET_KEY" ]; then
    ...
    echo -e "\n# langfuse's initial project's secret key.  (auto-generated secret)" >> quick_fill.secrets.env
...
if [ -z "$LANGFUSE_INIT_PROJECT_PUBLIC_KEY" ]; then
    ...
    echo -e "\n# # langfuse's initial project's public key.  (auto-generated secret)" >> quick_fill.secrets.env
