    ...
    if not client.collections.exists(_COLLECTION_NAME):
        ...
        client.collections.create(
            ...
            properties=[
                ...
                Property(name=_TEXT_KEY, data_type=DataType.TEXT,
                         index_filterable=True, index_range_filters=False, index_searchable=True,
                         tokenization=Tokenization.WORD),
                Property(name='content_type', data_type=DataType.TEXT,
                         index_filterable=True, index_range_filters=False, index_searchable=True,
                         tokenization=Tokenization.FIELD),
                Property(name='document_set_id', data_type=DataType.UUID,
                         index_filterable=True, index_range_filters=False, index_searchable=False),
