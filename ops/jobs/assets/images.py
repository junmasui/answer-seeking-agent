...
def _make_image_build_asset(directory: str, deps: Optional[List[AssetsDefinition]] = None) -> AssetsDefinition:
...
# "slim-util", "seaweedfs", "redis", "opensearch", "traefik", "weaviate", "api-server", "mlflow", "file-sync"
...
mlflow_image = _make_image_build_asset("mlflow")
file_sync_image = _make_image_build_asset("file-sync")
